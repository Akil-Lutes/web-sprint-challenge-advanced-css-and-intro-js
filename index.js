...
function removeArtist(arr, num1){
  arr.splice(num1, 1);
  return arr.length;
}
...
console.log(addArtist(artists, '20', 'Akil', '1991 - 2021', 'Web Design', 'American', 'I was born in North Carolina. I graudated from UNC Charlotte. I will be a great developer one day and live happily by myself playing video games.'));
